...
export default function App() {
  ...
  const [language, setLanguage] = React.useState('id'); // Default ke Bahasa Indonesia
  ...
  const handleSubmit = async (e) => {
    ...
    // Skema JSON untuk output yang terstruktur
    const schema = {
        type: "OBJECT",
        properties: {
            harokat: { type: "STRING" },
    ...
    try {
        ...
        const apiKey = ""; // Kunci API akan disediakan oleh environment
      ...
      console.error(err);
      setError('Terjadi kesalahan saat memproses teks. Silakan coba lagi.');
    } finally {
      setIsLoading(false);
    }
  };
